...
const loadDataMonthlyTables = (data) => {
    ...
    let groupsCounter = [1, 1, 1, 1];
    let moneyCounter = [0, 0, 0, 0];
    let moneyFromGroup = 22;
    let operatorColors = ["#800080", "#4a90e2", "#ff8a60", "#39caba"];
    ...
    document.querySelectorAll(".totalGroups")[3].textContent = "0 групи";
    ...
    document.querySelectorAll(".totalMoney")[3].textContent = "0";
    ...
    let allMoneyFromGroups = parseInt(document.querySelectorAll(".totalMoney")[0].textContent) + 
                             ...
                             parseInt(document.querySelectorAll(".totalMoney")[3].textContent);
